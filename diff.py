...
def main(argv): 
    ...
    for f1, f2 in zip(mac1, mac2):
        ...
        if (f2.find(ptssrc)!=-1):
            ...
            os.system("mkdir -p output_delay")
            delayLog = open("output_delay/"+fname, 'wb')
            ...
            for key, value in x.iteritems():
                ...
                #print a
                #print b
            os.system("./conmon-rtp-delay.sh output_delay/"+fname.split (".")[0])
            delayLog.close
    build_output_distribution(iteration)
